...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"gameController\": () => (/* binding */ gameController)\n/* harmony export */ });\n/* harmony import */ var _player__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./player */ \"./src/player.js\");\n/* harmony import */ var _dom__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./dom */ \"./src/dom.js\");\n/* harmony import */ var _gameboard__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./gameboard */ \"./src/gameboard.js\");\n\n\n\n\nlet gameController = (() => {\n    let players = [];\n    let active = players[0];\n  \n    let playerBoard = (0,_gameboard__WEBPACK_IMPORTED_MODULE_2__.gameboards)(\"player\");\n    let computerBoard = (0,_gameboard__WEBPACK_IMPORTED_MODULE_2__.gameboards)(\"computer\");\n\n    let player = (0,_player__WEBPACK_IMPORTED_MODULE_0__.userPlayer)(\"Kevin\", computerBoard);\n    let computer = (0,_player__WEBPACK_IMPORTED_MODULE_0__.computerPlayer)(\"Watson\", playerBoard);\n    players.push(player,computer)\n    \n\n    ;(0,_dom__WEBPACK_IMPORTED_MODULE_1__.dom)(playerBoard).renderBoard();\n    (0,_dom__WEBPACK_IMPORTED_MODULE_1__.dom)(computerBoard).renderBoard();\n\n    document.addEventListener(\"click\", (el) => {\n    if(el.target.classList.contains(\"block\")){\n        console.log(el.target.dataset.id)\n        let value = el.target.dataset.id.toString().split(\"\")\n        player.attack(Number.parseInt(value[0]), Number.parseInt(value[1]))\n        ;(0,_dom__WEBPACK_IMPORTED_MODULE_1__.dom)(computerBoard).clearBoard();\n        (0,_dom__WEBPACK_IMPORTED_MODULE_1__.dom)(computerBoard).renderBoard();\n        computer.attack();\n        (0,_dom__WEBPACK_IMPORTED_MODULE_1__.dom)(playerBoard).clearBoard();\n        (0,_dom__WEBPACK_IMPORTED_MODULE_1__.dom)(playerBoard).renderBoard();\n        \n\n\n    }\n    })\n\n\n})()\n\n\n\n//# sourceURL=webpack://battleship/./src/game.js?");
